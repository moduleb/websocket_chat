...
3. Сохранение истории сообщений:
   ...
   - При выборе чата с определенным участником пользователь видит историю переписки между пользователями.
...
5. Веб-интерфейс для тестирования:
   ...
   - Веб-интерфейс может быть реализован на JS, CSS, HTML.
...
- Базы данных:
   ...
   - Redis в качестве очереди задач и для хранения сессий.
- ORM и миграции:
